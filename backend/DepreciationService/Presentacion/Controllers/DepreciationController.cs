...
namespace DepreciationService.Presentacion.Controllers;
...
public class DepreciationController : ControllerBase
{
            ...
            string token)
    {
        ...
        if (fechaHasta.Date < activo.FechaCompra.Date)
        {
        ...
        if (ultimoPeriodo < periodosSolicitados)
        {
        ...
        [FromBody] DepreciationRequest request)
    {
        ...
        try
        {
            ...
            if (resultado.PeriodosSolicitados == 0)
            {
                return Ok(
                    new
                    {
